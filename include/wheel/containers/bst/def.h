...
#define bst_node        LIBWHEEL_DEFINE(bst, node)
#define bst_node_init   LIBWHEEL_DEFINE(bst, node_init)
#define bst_node_remove LIBWHEEL_DEFINE(bst, node_remove)
#define bst_node_delete LIBWHEEL_DEFINE(bst, node_delete)
